...
/*
 * %W% %E% Copyright (c) 2006, Oracle and/or its affiliates. All rights
 * reserved. ORACLE PROPRIETARY/CONFIDENTIAL. Use is subject to license terms.
 */
...
public abstract class AbstractListImpl<E> extends AbstractCollection<E> implements List<E>
{
	...
	private class ListItr extends Itr implements ListIterator<E>
	{
		...
		public void add(E e)
		{
			...
			try
			{
				AbstractListImpl.this.add(cursor++, e);
				lastRet = -1;
				expectedModCount = modCount;
			}
			catch (IndexOutOfBoundsException ex)
	...
	{
		return (this instanceof RandomAccess ? new RandomAccessSubList<E>(this, fromIndex, toIndex) : new SubList<E>(
