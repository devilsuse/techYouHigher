...
public class MakeItAnagram
{
	...
	// anagrams are very useful. Two strings are anagrams of each other if they
	// have same character set. For example strings "bacdc" and "dcbac" are
	...
	// 4
	// Explanation #00:
	// We need to delete 4 characters to make both strings anagram i.e. ‘d’ and
	// ‘e’ from first string and ‘b’ and ‘a’ from second string.
