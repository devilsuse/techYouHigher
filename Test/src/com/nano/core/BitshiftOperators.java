...
public class BitshiftOperators
{
	...
	{
		int i = -16;
		System.out.println("With Negative number >>> gives DIFFERENT results...........\n");

		System.out.println("i = " + i + " 2 * i = " + multiplyByPowerOfTwo(i, 1));
		System.out.println("i = " + i + " 2 / i = " + divideByPowerOfTwo(i, 1));
		System.out.println("unSignedRightShiftOperator -> " + unSignedRightShiftOperator(i));
